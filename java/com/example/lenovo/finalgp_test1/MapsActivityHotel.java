...
public class MapsActivityHotel extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    String longi, lati, hotelName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        longi = ReserveHotelActivity.hotelLong;
        lati = ReserveHotelActivity.hotelLat;
        hotelName = ReserveHotelActivity.hotelNamee;
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(location).title(hotelName));
